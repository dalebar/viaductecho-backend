...
class TestArticlesEndpoints:
    ...
    def test_get_articles_with_source_filter(self, mock_get_db, client, mock_api_operations, sample_articles):
    ...
    @patch('api.routes.articles.get_db')
    def test_get_articles_validation(self, mock_get_db, client, mock_api_operations):
        """Test articles endpoint parameter validation"""
        # Setup mock
        mock_get_db.return_value = mock_api_operations
        mock_api_operations.get_articles_paginated.return_value = ([], 0)

        # Test invalid page number (should be normalized)
    ...
    @patch('api.routes.articles.get_db')
    def test_get_articles_database_error(self, mock_get_db, client, mock_api_operations):
    ...
    @patch('api.routes.articles.get_db')
    def test_get_article_by_id_success(self, mock_get_db, client, mock_api_operations, sample_article):
    ...
    @patch('api.routes.articles.get_db')
    def test_get_article_by_id_not_found(self, mock_get_db, client, mock_api_operations):
    ...
    @patch('api.routes.articles.get_db')
    def test_get_article_by_id_database_error(self, mock_get_db, client, mock_api_operations):
    ...
    @patch('api.routes.articles.get_db')
    def test_get_recent_articles_success(self, mock_get_db, client, mock_api_operations, sample_recent_articles):
    ...
    @patch('api.routes.articles.get_db')
    def test_get_recent_articles_defaults(self, mock_get_db, client, mock_api_operations):
    ...
    @patch('api.routes.articles.get_db')
    def test_get_recent_articles_validation(self, mock_get_db, client, mock_api_operations):
    ...
    @patch('api.routes.articles.get_db')
    def test_search_articles_success(self, mock_get_db, client, mock_api_operations, sample_articles):
    ...
    @patch('api.routes.articles.get_db')
    def test_search_articles_empty_query(self, mock_get_db, client, mock_api_operations):
    ...
    @patch('api.routes.articles.get_db')
    def test_search_articles_no_results(self, mock_get_db, client, mock_api_operations):
    ...
    @patch('api.routes.articles.get_db')
    def test_search_articles_database_error(self, mock_get_db, client, mock_api_operations):
    ...
    @patch('api.routes.articles.get_db')
    def test_pagination_info_calculation(self, mock_get_db, client, mock_api_operations, sample_articles):
        ...
        assert pagination["has_next"] == True   # page 3 of 5
        assert pagination["has_prev"] == True   # page 3

    @patch('api.routes.articles.get_db')
    def test_pagination_edge_cases(self, mock_get_db, client, mock_api_operations):
