...
class TestContentExtractor:
    ...
    def sample_men_html_array(self):
        ...
        json_data = [
            ...
            {
                "articleBody": "Second article body",
    ...
    def test_extract_bbc_content_success(self, mock_get, mock_sleep, extractor, mock_response, sample_bbc_html):
        ...
        mock_get.assert_called_once_with(
            'https://www.bbc.com/news/test-article',
        ...
        assert result['content'] == 'First paragraph of BBC article content.\n\nSecond paragraph with more details about the story.'
    ...
    def test_url_routing_bbc(self, extractor):
        ...
        with patch.object(extractor, '_extract_bbc_content') as mock_bbc:
            ...
            with patch('processors.content_extractor.requests.get') as mock_get, \
                 patch('processors.content_extractor.time.sleep'):
