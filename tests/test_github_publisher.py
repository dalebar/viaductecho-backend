...
class TestGitHubPublisher:
    ...
    def test_create_slug_length_limit(self, mock_config):
        ...
        long_title = "This is a very long article title that should be truncated because it exceeds the fifty character limit"
    ...
    def test_create_jekyll_content(self, mock_config, sample_article_data, sample_summary, sample_image_url):
        ...
        assert f"[Read the full article at {sample_article_data['original_source']}]({sample_article_data['original_link']})" in content
        assert content.endswith("---\n")

    @patch('publishers.github_publisher.datetime')
    @patch('publishers.github_publisher.requests.put')
    @patch('publishers.github_publisher.Config')
    def test_publish_article_success(self, mock_config, mock_put, mock_datetime, 
    ...
    @patch('publishers.github_publisher.requests.put')
    @patch('publishers.github_publisher.Config')
    def test_publish_article_api_failure(self, mock_config, mock_put, mock_datetime,
                                        sample_article_data, sample_summary, sample_image_url,
    ...
    @patch('publishers.github_publisher.requests.put')
    @patch('publishers.github_publisher.Config')
    def test_publish_article_exception(self, mock_config, mock_put,
                                      sample_article_data, sample_summary, sample_image_url):
    ...
    @patch('publishers.github_publisher.requests.put')
    @patch('publishers.github_publisher.Config')
    def test_publish_article_different_status_codes(self, mock_config, mock_put, mock_datetime,
                                                   sample_article_data, sample_summary, sample_image_url):
    ...
    def test_jekyll_content_structure(self, mock_config):
        ...
        assert f"[Read the full article at {article_data['original_source']}]({article_data['original_link']})" in content_body
