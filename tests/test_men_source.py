...
class TestMENSource:
    ...
    def test_fetch_articles_success(self, mock_feedparser, mock_config):
        ...
        with patch('logging.info') as mock_log_info:
            ...
            assert articles[0]['original_link'] == "https://www.manchestereveningnews.co.uk/news/stockport-redevelopment"
            ...
            assert articles[1]['original_link'] == "https://www.manchestereveningnews.co.uk/sport/manchester-united-transfer"
    ...
    def test_fetch_articles_preserves_all_fields(self, mock_feedparser, mock_config):
        ...
        expected_keys = {'original_title', 'original_link', 'original_summary', 
                        'original_source', 'source_type', 'original_pubdate'}
...
class TestMENSourceIntegration:
    ...
    def test_error_recovery(self, mock_config):
        ...
        for error in error_scenarios:
            with patch('sources.men_source.feedparser.parse') as mock_feedparser, \
    ...
    def test_real_world_rss_structure(self, mock_feedparser, mock_config):
        ...
        assert article['original_link'] == "https://www.manchestereveningnews.co.uk/sport/football/stockport-county-fc-transfers-2024"
